    ...
    return (
        <div id="CarouselComponent" className="carousel slide" data-bs-ride="carousel">
            ...
            <div className="carousel-item">
                    <img src={BlogData[15].img} alt="Slide1" width="800" height="450" class="d-block w-100" />
                ...
                <div className="carousel-item">
                    <img src={BlogData[14].img} alt="Slide1" width="800" height="450" class="d-block w-100" />
                    <div className="carousel-caption">
                ...
                <div className="carousel-item active">
                    <img src={BlogData[41].img} alt="Slide1" width="800" height="450" class="d-block w-100"/>
                    <div className="carousel-caption">
